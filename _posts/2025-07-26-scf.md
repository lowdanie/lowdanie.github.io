...
The algorithms in this series are implemented the [slaterform](https://github.com/lowdanie/hartree-fock-solver) library. 

As an example, we can initialize a water molecule with the hydrogen atoms at
an incorrect 180 degree angle, and then optimize its geometry by following the energy gradient.
Here is a visualization of the resulting nuclei and electron density trajectories:

<video width=544 height=548 controls preload="metadata" style="display: block; margin: 0 auto; max-width: 100%; height: auto;">
    <source src="/assets/scf/water_web_optimized.mp4" type="video/mp4">
</video>

For more examples, see this
[colab notebook](https://colab.research.google.com/github/lowdanie/hartree-fock-solver/blob/main/notebooks/geometry_optimization.ipynb).
